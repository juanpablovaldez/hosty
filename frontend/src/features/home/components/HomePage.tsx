    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-5 lg:px-8 py-12 lg:py-16">
        <div className="flex items-end justify-between mb-8">
          ...
          <a href="/salones" className="hidden md:inline-flex items-center gap-1.5 text-[14px] font-semibold text-primary hover:text-primary/80 transition">
            Ver todos
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
          ...
          {[
            ...
            <article key={salon.nombre} className="group cursor-pointer">
              ...
              >
                ...
                <button className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/90 hover:bg-white flex items-center justify-center transition">
